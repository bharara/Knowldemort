...
<script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.js"></script>
    <title><?php echo $row["Name"]; ?>'s Profile - Knowldemort</title>
...
<?php
       ...
       echo "0 results";
        ...
        ?>
<div class="userbox col-12" style="height:500px;">
...
?>
 ...
 <?php
     ...
     ?>
    <button type=button class="center col-12" id="seemore">See More <i class="fa fa-arrow-down"></i></button>
    </div>
</div>
